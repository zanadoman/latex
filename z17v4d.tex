...
\usepackage{amsthm,listings,array,pdfpages}
...
\begin{itemize}
    ...
    \item \textbf{Plazma puska}: gyorstüzelésű plazmafegyver, plazma cellákat
        használ lőszerként.
    \item \textbf{BFG 9000}: teljes nevén: \textqq{Big Fucking Gun 9000},
        magyarul: \textqq{Kibaszott Nagy Fegyver 9000}, nagy teljesítményű
...
\begin{pelda}
    \label{pld:reverse}
    \Aref{lst:reverse} programkód rekurzió felhasználásával fordít meg egy
    végjellel ellátott karakterláncot.
\end{pelda}

További \aref{pld:reverse} példához hasonló, rekurzióval kapcsolatos példákért
